...
{	
	...
	while (game == 0)
	{
		slime.gold_drop = 25 + ((rand() % 5) - (rand() % 5));
		wolf.gold_drop = 50 + ((rand() % 10) - (rand() % 10));
		skeleton.gold_drop = 50 + ((rand() % 10) - (rand() % 10));
		orc.gold_drop = 125 + ((rand() % 20) - (rand() % 20));
		troll.gold_drop = 200 + ((rand() % 30) - (rand() % 30));
		golem.gold_drop = 450 + ((rand() % 50) - (rand() % 50));
		kong.gold_drop = 700 + ((rand() % 50) - (rand() % 50));
		...
		while(story == 7.3) //Dwarf store
        {
			...
			printf("You step into the store and see lots of armor and weapons on the shelves. And you seem amazed when you look around and see so many things on sale. A little dwarf girl salesman walks up to you, then stops and ask.\n\n");
				SpeechBox();
            printf("\"Hi, our customer. What would you like to buy from our store?\"\n\n");
                EndTextColor();
			printf("You answer....\n");
			printf("1. I want to see what the store has to sell.\n2. Go outside the store.\n\n");
			printf("Type : ");
		...
		while(story == 7.31) //Dwarf store sell list
		{
			ClearScreen();
			...
			SpeechBox();
			printf("\" Welcome adventure!! Got some rare things on sale!! What you want to buy in our store?\"\n\n");
				EndTextColor();
...
void Golem()
{
	...
	, {"  |______________|_____|______________________|________________|    \n"}};
...
void Kong()
{
	...
	, {"     //          \\WWWWW              |  ||\\           /||   |         WWWWW/        \\\\         \n"}
	, {"   //      A      \\WWWWW             \\  || \\         / ||  /          WWW/      A     \\\\      \n"}
	, {" //   ____/_\\___   \\WWW_______________\\__\\\\_\\_______/_//__/__________WWW/  ____/_\\____  \\\\\n"}
	, {" //                 \\                 \\\\                  //           /                \\\\    \n"}
	, {"//___________________|_________________||________________||___________|__________________\\\\      \n"}};
